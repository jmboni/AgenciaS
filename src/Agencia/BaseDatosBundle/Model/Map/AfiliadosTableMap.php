...
use Agencia\BaseDatosBundle\Model\Afiliados;
use Agencia\BaseDatosBundle\Model\AfiliadosQuery;
...
class AfiliadosTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Agencia.BaseDatosBundle.Model.Map.AfiliadosTableMap';
     ...
     */
    const OM_CLASS = '\\Agencia\\BaseDatosBundle\\Model\\Afiliados';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Agencia.BaseDatosBundle.Model.Afiliados';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Agencia\\BaseDatosBundle\\Model\\Afiliados');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Agencia\BaseDatosBundle\Model\Afiliados) { // it's a model object
