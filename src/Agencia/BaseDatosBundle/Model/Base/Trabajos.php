...
abstract class Trabajos implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Agencia\\BaseDatosBundle\\Model\\Map\\TrabajosTableMap';
    ...
    /**
     * Initializes internal state of Agencia\BaseDatosBundle\Model\Base\Trabajos object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Agencia\BaseDatosBundle\Model\Trabajos The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 16; // 16 = TrabajosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Agencia\\BaseDatosBundle\\Model\\Trabajos'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Agencia\BaseDatosBundle\Model\Trabajos
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Agencia\BaseDatosBundle\Model\Trabajos The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Agencia\BaseDatosBundle\Model\Trabajos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Agencia\BaseDatosBundle\Model\Trabajos Clone of current object.
     * @throws PropelException
     */
