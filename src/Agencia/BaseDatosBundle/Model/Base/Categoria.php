...
use Agencia\BaseDatosBundle\Model\Trabajos as ChildTrabajos;
use Agencia\BaseDatosBundle\Model\TrabajosQuery as ChildTrabajosQuery;
use Agencia\BaseDatosBundle\Model\Map\CategoriaAfiliadoTableMap;
use Agencia\BaseDatosBundle\Model\Map\CategoriaTableMap;
use Agencia\BaseDatosBundle\Model\Map\TrabajosTableMap;
...
abstract class Categoria implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Agencia\\BaseDatosBundle\\Model\\Map\\CategoriaTableMap';
    ...
    /**
     * Initializes internal state of Agencia\BaseDatosBundle\Model\Base\Categoria object.
     */
     ...
     * @return $this|\Agencia\BaseDatosBundle\Model\Categoria The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = CategoriaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Agencia\\BaseDatosBundle\\Model\\Categoria'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->trabajossScheduledForDeletion !== null) {
                if (!$this->trabajossScheduledForDeletion->isEmpty()) {
                    \Agencia\BaseDatosBundle\Model\TrabajosQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Agencia\BaseDatosBundle\Model\Categoria
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Agencia\BaseDatosBundle\Model\Categoria The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Agencia\BaseDatosBundle\Model\Categoria (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Agencia\BaseDatosBundle\Model\Categoria Clone of current object.
     * @throws PropelException
     */
    ...
    public function initTrabajoss($overrideExisting = true)
    {
        ...
        $this->collTrabajoss->setModel('\Agencia\BaseDatosBundle\Model\Trabajos');
    }
