...
use Agencia\BaseDatosBundle\Model\Map\CategoriaTableMap;
 ...
 *
 * @method     \Agencia\BaseDatosBundle\Model\TrabajosQuery|\Agencia\BaseDatosBundle\Model\CategoriaAfiliadoQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoriaQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Agencia\BaseDatosBundle\Model\Base\CategoriaQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Agencia\\BaseDatosBundle\\Model\\Categoria', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Agencia\BaseDatosBundle\Model\Trabajos object
     *
     * @param \Agencia\BaseDatosBundle\Model\Trabajos|ObjectCollection $trabajos the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($trabajos instanceof \Agencia\BaseDatosBundle\Model\Trabajos) {
            return $this
            ...
            throw new PropelException('filterByTrabajos() only accepts arguments of type \Agencia\BaseDatosBundle\Model\Trabajos or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Agencia\BaseDatosBundle\Model\TrabajosQuery A secondary query class using the current class as primary query
     */
    public function useTrabajosQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinTrabajos($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Trabajos', '\Agencia\BaseDatosBundle\Model\TrabajosQuery');
    }
