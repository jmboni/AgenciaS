...
use Agencia\BaseDatosBundle\Model\CategoriaAfiliado as ChildCategoriaAfiliado;
...
/**
 * Base class that represents a row from the 'afiliados' table.
 *
 * 
 *
* @package    propel.generator.src.Agencia.BaseDatosBundle.Model.Base
*/
abstract class Afiliados implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Agencia\\BaseDatosBundle\\Model\\Map\\AfiliadosTableMap';
    ...
    /**
     * Initializes internal state of Agencia\BaseDatosBundle\Model\Base\Afiliados object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Afiliados</code> instance.  If
     * <code>obj</code> is an instance of <code>Afiliados</code>, delegates to
     * <code>equals(Afiliados)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Afiliados The current object, for fluid interface
     */
     ...
     * @return $this|\Agencia\BaseDatosBundle\Model\Afiliados The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AfiliadosTableMap::COL_ID] = true;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[AfiliadosTableMap::COL_URL] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[AfiliadosTableMap::COL_EMAIL] = true;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[AfiliadosTableMap::COL_TOKEN] = true;
        }
    ...
    public function setActivado($v)
    {
        ...
        if ($this->activado !== $v) {
            $this->activado = $v;
            $this->modifiedColumns[AfiliadosTableMap::COL_ACTIVADO] = true;
        }
    ...
    public function setCreado($v)
    {
        ...
        if ($this->creado !== null || $dt !== null) {
            if ($this->creado === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->creado->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AfiliadosTableMap::COL_CREADO] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AfiliadosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AfiliadosTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            $this->url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AfiliadosTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AfiliadosTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
            $this->token = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AfiliadosTableMap::translateFieldName('Activado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->activado = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AfiliadosTableMap::translateFieldName('Creado', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = AfiliadosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Agencia\\BaseDatosBundle\\Model\\Afiliados'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAfiliadosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Afiliados::setDeleted()
     * @see Afiliados::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAfiliadosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AfiliadosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->categoriaAfiliadosScheduledForDeletion !== null) {
                if (!$this->categoriaAfiliadosScheduledForDeletion->isEmpty()) {
                    \Agencia\BaseDatosBundle\Model\CategoriaAfiliadoQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AfiliadosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_URL)) {
            $modifiedColumns[':p' . $index++]  = 'url';
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = 'token';
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_ACTIVADO)) {
            $modifiedColumns[':p' . $index++]  = 'activado';
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_CREADO)) {
            $modifiedColumns[':p' . $index++]  = 'creado';
        }

        $sql = sprintf(
            'INSERT INTO afiliados (%s) VALUES (%s)',
    ...
    {
        $pos = AfiliadosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Afiliados'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Afiliados'][$this->hashCode()] = true;
        $keys = AfiliadosTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUrl(),
            $keys[2] => $this->getEmail(),
            $keys[3] => $this->getToken(),
            $keys[4] => $this->getActivado(),
            $keys[5] => $this->getCreado(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Agencia\BaseDatosBundle\Model\Afiliados
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setActivado($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setCreado($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Agencia\BaseDatosBundle\Model\Afiliados The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AfiliadosTableMap::COL_ID)) {
            $criteria->add(AfiliadosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_URL)) {
            $criteria->add(AfiliadosTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_EMAIL)) {
            $criteria->add(AfiliadosTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_TOKEN)) {
            $criteria->add(AfiliadosTableMap::COL_TOKEN, $this->token);
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_ACTIVADO)) {
            $criteria->add(AfiliadosTableMap::COL_ACTIVADO, $this->activado);
        }
        if ($this->isColumnModified(AfiliadosTableMap::COL_CREADO)) {
            $criteria->add(AfiliadosTableMap::COL_CREADO, $this->creado);
        }
    ...
    {
        $criteria = ChildAfiliadosQuery::create();
        $criteria->add(AfiliadosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Agencia\BaseDatosBundle\Model\Afiliados (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Agencia\BaseDatosBundle\Model\Afiliados Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCategoriaAfiliados($overrideExisting = true)
    {
        ...
        $this->collCategoriaAfiliados->setModel('\Agencia\BaseDatosBundle\Model\CategoriaAfiliado');
    }
     ...
     * If this ChildAfiliados is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAfiliados The current object (for fluent API support)
     */
    public function setCategoriaAfiliados(Collection $categoriaAfiliados, ConnectionInterface $con = null)
    {
        ...
        foreach ($categoriaAfiliadosToDelete as $categoriaAfiliadoRemoved) {
            $categoriaAfiliadoRemoved->setAfiliados(null);
        }
    ...
    protected function doAddCategoriaAfiliado(ChildCategoriaAfiliado $categoriaAfiliado)
    {
        ...
        $categoriaAfiliado->setAfiliados($this);
    }
    ...
    public function removeCategoriaAfiliado(ChildCategoriaAfiliado $categoriaAfiliado)
    {
        if ($this->getCategoriaAfiliados()->contains($categoriaAfiliado)) {
            ...
            $categoriaAfiliado->setAfiliados(null);
        }
     ...
     * Otherwise if this Afiliados is new, it will return
     * an empty collection; or if this Afiliados has previously
     * been saved, it will retrieve related CategoriaAfiliados from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Afiliados.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildCategoriaAfiliado[] List of ChildCategoriaAfiliado objects
     */
    public function getCategoriaAfiliadosJoinCategoria(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCategoriaAfiliadoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(AfiliadosTableMap::DEFAULT_STRING_FORMAT);
    }
